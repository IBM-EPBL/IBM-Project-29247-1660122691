...
def get_item(bucket_name, item_name):
    ...
    try:
        ...
        # im = Image.SAVE(file)
        # readrawdata = file.i
        # df = pickle.load(BytesIO(readrawdata))
        # print (df)
        r = format(file["Body"].read())
        # print (type(r))
        # df = pd.read_excel(r)
        res = bytes(r, 'utf-8')        
        imageStream = io. BytesIO(res)
...
# Write to csv
        ...
        with open("album_art.jpg", "wb") as f:
         f.write(res)
        # print("File Contents: {0} sreenithi".format(file["Body"].read()))
#show image
        # im.show()
...
COS_ENDPOINT = "https://s3.au-syd.cloud-object-storage.appdomain.cloud" # example: https://s3.us-south.cloud-object-storage.appdomain.cloud
COS_API_KEY_ID = "d9MobColWYPhzobecQOmVDcLD2m0v0NktLGwjsFOdSEZ" # example: xxxd12V2QHXbjaM99G9tWyYDgF_0gYdlQ8aWALIQxXx4
COS_AUTH_ENDPOINT = "https://iam.cloud.ibm.com/identity/token"
COS_SERVICE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/e971bd3f516f4b269ddff54c6bf99740:0493bed1-e168-4bda-894d-3a0ee333b711::" # example: crn:v1:bluemix:public:cloud-object-storage:global:a/xx999cd94a0dda86fd8eff3191349999:9999b05b-x999-4917-xxxx-9d5b326a1111::
...
def main():
    try:
        ...
        # create_text_file(new_bucket_name, "sree.txt", "sreen   ithi")

        get_item(new_bucket_name, "dog.jpg")
